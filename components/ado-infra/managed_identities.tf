...
resource "azurerm_role_assignment" "mi_landing_contributor" {
  ...
  scope                = data.azurerm_storage_account.mi_landing_storage_account.id
...
resource "azurerm_role_assignment" "mi_pds_contributor" {
  ...
  scope                = data.azurerm_storage_account.mi_persistent_storage_account.id
  role_definition_name = "Storage Blob Data Contributor"
  principal_id         = local.managed_identity_object_name
}
resource "azurerm_role_assignment" "mi_export_contributor" {
  ...
  scope                = data.azurerm_storage_account.mi_export_storage_account.id
  role_definition_name = "Storage Blob Data Contributor"
  principal_id         = local.managed_identity_object_name
}
resource "azurerm_role_assignment" "mi_audit_contributor" {
  ...
  scope                = data.azurerm_storage_account.mi_audit_storage_account.id
  role_definition_name = "Storage Blob Data Contributor"
  principal_id         = local.managed_identity_object_name
}
resource "azurerm_role_assignment" "mi_polybasestaging_contributor" {
  ...
  scope                = data.azurerm_storage_account.mi_polybasestaging_storage_account.id
  role_definition_name = "Storage Blob Data Contributor"
  principal_id         = local.managed_identity_object_name
}
resource "azurerm_role_assignment" "mi_adhoc_contributor" {
  ...
  scope                = data.azurerm_storage_account.mi_adhoclanding_storage_account.id
  role_definition_name = "Storage Blob Data Contributor"
  principal_id         = local.managed_identity_object_name
}
resource "azurerm_role_assignment" "aks_mi_apintegration_contributor" {
  ...
  scope                = data.azurerm_storage_account.mi_apintegration_storage_account.id
  role_definition_name = "Storage Blob Data Contributor"
  principal_id         = local.managed_identity_object_name
}
resource "azurerm_role_assignment" "aks_mi_datasharelanding_contributor" {
  ...
  scope                = data.azurerm_storage_account.mi_datasharelanding_storage_account.id
  role_definition_name = "Storage Blob Data Contributor"
  principal_id         = local.managed_identity_object_name
}